...
class FeedFiltersLocalDataSource {
  ...
  final Future<Box<FeedFilters>> _feedFiltersBox = Hive.openBox<FeedFilters>(_boxName);
  ...
  Future<List<FeedFilters>> getAll() async {
    final box = await _feedFiltersBox;
    final List<FeedFilters> values = box.isNotEmpty ? box.values.toList() : [];
    return values;
  }
  ...
  static Future<void> clear() async {
    final box = await Hive.openBox<FeedFilters>(_boxName);
    await box.clear();
  }
}
